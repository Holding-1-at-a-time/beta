...
function DashboardContent() {
    ...
    if (estimates === undefined || invoices === undefined || appointments === undefined || transactions === undefined) {
        return <LoadingSkeleton />;
    }

    if (estimates === null || invoices === null || appointments === null || transactions === null) {
        return <ErrorDisplay message="Failed to fetch dashboard data. Please try again later." />;
    }
        ...
        <div className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <DashboardCard
                    ...
                    stats={[
                        { label: "Upcoming", value: appointments.filter(a => new Date(a.date) > new Date()).length },
