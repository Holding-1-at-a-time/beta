...
export const RecentEstimatesInvoices: React.FC = () => {
    ...
    const totalPages = activeTab === 'estimates'
        ? estimatesQuery && !(estimatesQuery instanceof Error) ? Math.ceil(estimatesQuery.totalCount / PAGE_SIZE) : 1
        : invoicesQuery && !(invoicesQuery instanceof Error) ? Math.ceil(invoicesQuery.totalCount / PAGE_SIZE) : 1;
